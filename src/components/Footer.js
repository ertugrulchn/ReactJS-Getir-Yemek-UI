      ...
      <div className="container mx-auto">
        ...
        <div className="flex justify-between items-center border-t border-gray-100 mt-6 py-6">
          ...
          <nav className="flex gap-x-3">
            ...
            <a
              href="#"
              className="h-8 transition-colors hover:bg-primary-brand-color hover:bg-opacity-10 hover:text-primary-brand-color hover:border-transparent flex items-center px-2 text-sm gap-x-2 rounded text-gray-500 border-gray-100"
            >
              <BiGlobe size={18} />
              Türkçe (TR)
            </a>
